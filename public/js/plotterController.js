...
var plotterController = function(serverUrl)
{
    ...
    function preset01()
    {
        ...
        //gui_zText.setValue("10 * (0.0828 * x * y)^ 5.1550 / (1 + (0.0828 * x * y)^ 5.1550)");
        gui_zText.setValue("10 * (0.0828 * (x * 0.1)* (y*0.1))^ 5.1550 / (1 + (0.0828 * (x * 0.1) * (y*0.1))^ 5.1550)");
